...
let chatBottomLocks = new Map();
let chatBottomLockFrames = new Map();
let chatBottomLockTimeouts = new Map();
let chatBottomLockObservers = new Map();
